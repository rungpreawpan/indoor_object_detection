...
//
// class ObstacleDetectionResultPage extends StatefulWidget {
//   final File imageFile;
//
//   const ObstacleDetectionResultPage({
//     super.key,
//     required this.imageFile,
//   });
//
//   @override
//   State<ObstacleDetectionResultPage> createState() =>
//       _ObstacleDetectionResultPageState();
// }
//
// class _ObstacleDetectionResultPageState extends State<ObstacleDetectionResultPage> {
//   // final ObjectDetectionController _objectDetectionController = Get.find();
//   final ObstacleController _obstacleController = Get.find();
...
//     _obstacleController.obstacleDetected?.boxes
//         ?.asMap()
//         .forEach((index, _) {
//       _objectColors[index] =
...
//
//   Future _speak() async {
//     if (_obstacleController.obstacleDetected?.boxes != null) {
//       List<String> objects = [];
//       translatedText = null;
//
//       for (ObstacleBoxesModel object
//       in _obstacleController.obstacleDetected!.boxes!) {
...
//
//   _objectImage() {
//     if (_obstacleController.obstacleDetected == null ||
//         _imageSize == null) {
...
//     double scaleX =
//         displayWidth / _obstacleController.obstacleDetected!.imageWidth!;
//     double scaleY = (displayWidth * _imageSize!.height / _imageSize!.width) /
//         _obstacleController.obstacleDetected!.imageHeight!;
//     // print(scaleX);
//     // print(scaleY);
//
//     return Stack(
...
//
//   _objectLabels() {
//     return _obstacleController.obstacleDetected != null &&
//         _obstacleController.obstacleDetected!.boxes!.isNotEmpty
//         ? ListView.builder(
//       shrinkWrap: true,
//       physics: const NeverScrollableScrollPhysics(),
//       itemCount: _obstacleController.obstacleDetected!.boxes!.length,
//       itemBuilder: (context, index) {
//         ObstacleBoxesModel item =
//         _obstacleController.obstacleDetected!.boxes![index];
//
//         return ListTile(
//           leading: Container(
//             height: 40.0,
